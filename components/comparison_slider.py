...
def render_comparison_slider():
    ...
    with col1:
        ...
        st.plotly_chart(radar_a, use_container_width=True, key=f"radar_compare_a_{platform_a}")
    ...
    with col2:
        ...
        st.plotly_chart(radar_b, use_container_width=True, key=f"radar_compare_b_{platform_b}")
